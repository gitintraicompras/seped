...
class ProcesarAlcabala extends Command
{
    ...
    public function handle() {
        ...
        //         PARA EL CASO DE PEDIDOS QUE VENGAN DE DIFERENTES PORTALES TAL COMO ISACOM
        $ped = DB::table('pedido')
        ...
        // FASE 2: RUTINA DE SEPARACION DE PEDIDOS 
        //         PARTE LOS PEDIDOS, SEGUN TABLA DE CRITERIOS DE SEPARACION
                        ...
                        foreach ($pedren as $pr) {
                            ...
                            if ($criterio2) {
                                ...
                                try {
                                    ...
                                    log::info("PEDIDO: ".$id." CODPROD: ".$pr->codprod." CRITERIO: ".$criterio." APLICA CRITERIO");
        ...
        // FASE 3: RUTINA DE VERIFICACION DE PEDIDO PARA PARTIRLO
        //         Y ASIGNA EL LOTE
        $ped = DB::table('pedido')
        ->where('estado','=','PRE-APROBADO')
        ->get();
                ...
                if ($pr->manejalote == '3' && $contlote > 0) {
                    ...
                    foreach ($lotes as $l) {
                        ...
                        if ($renglon >= $numRengPedido)  {
                            log::info("FASE3-ALCABALA(".$modoAlcabala.") ORI: ".$id." RENG(".$p->numren.") PARCIAL: ".$idx. " RENG(".$renglon.")"); 
                            $renglon = 0;
                            $crearpedido = 0;
                        }
                    }
        ...
        // FASE 4: ACTUALIZO EN UNA SOLA CORRIDA TODOS LOS PEDIDOS DE PARCIAL - APROBADOS
        $ped = DB::table('pedido')
        ...
        foreach ($ped as $p) {
            ...
            log::info("FASE4-ALCABALA(".$modoAlcabala.") ID: ".$idx." APROBADO"); 
        }
