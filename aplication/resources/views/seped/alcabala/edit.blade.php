...
@section('contenido')
    ...
    <div class="row">
        ...
        @else
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    ...
                    <input readonly style="text-align: right;" type="text"
                        value="{{ number_format($tabla->limite, 2, '.', ',') }}" class="form-control">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label>Saldo deudor</label>
                    <input readonly style="text-align: right;" type="text"
                        value="{{ number_format($tabla->saldo, 2, '.', ',') }}" class="form-control">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label>Monto vencido</label>
                    <input readonly style="text-align: right;" type="text"
                        value="{{ number_format($tabla->vencido, 2, '.', ',') }}" class="form-control">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="form-group">
                    <label>Monto del pedido</label>
                    <input readonly style="text-align: right;" type="text"
                        value="{{ number_format($tabla->total, 2, '.', ',') }}" class="form-control">
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
				...
				@if ($disp < 0) color: red @endif;"
                        type="text" class="form-control" value="{{ number_format($disp, 2, '.', ',') }}"
                        title="Disponible = Limite de Crédito - (Saldo deudor + Monto del pedido)">
                </div>
            </div>
        @endif
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label>Estado</label>
                <input readonly style="@if ($tabla->estadocliente == 'INACTIVO') color: red @endif;" type="text"
                    class="form-control" value="{{ $tabla->estadocliente }}" title="Estado del cliente">
            </div>
        </div>
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                <label>Dias crédito</label>
                <input readonly style="text-align: right;" type="text" value="{{ $tabla->dcredito }}"
                    class="form-control">
            </div>
        </div>
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                @if (Auth::user()->tipo == 'V')
                    <input readonly name="observacion" type="text" class="form-control"
                        value="{{ $tabla->observacion }}">
                @else
        ...
        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
            <div class="form-group">
                ...
                @if (Auth::user()->tipo == 'V')
                    <input readonly name="codtransp" type="text" class="form-control"
                        value="{{ $tabla->codtransp }}">
                @else
