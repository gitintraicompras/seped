...
{!! Form::open(array('url'=>'/seped/carga','method'=>'POST','autocomplete'=>'off', 'enctype'=>'multipart/form-data')) !!}
{{ Form::token() }}
    ...
    <div class="row">
		...
		<div class="col-lg-9 col-md-9 col-sm-9" style="width: 60%;">
			...
			<div class="row">
				...
				<div class="form-group">
			        <label>Descripción del contenido del archivo:</label>
		            <input type="text" class="form-control" name="descrip" value="" >
			    </div>
			</div>
