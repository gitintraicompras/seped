		...
		<div class="col-md-4">
			...
			<div class="info-box bg-green info-box-20"
				...
				<div class="info-box-content info-box-content-20">
				  <span class="info-box-text">Facturas ( {{date('d-m-Y')}} )</span>
				  <span class="info-box-number">{{number_format($totVentas,2, '.', ',')}} </span>
				  <div class="progress">
				    <div class="progress-bar" style="width: 20%"></div>
				  </div>
				  <span class="progress-description">
				  	@if ($cfg->mostrarPrecioOM == 1)
				  		<b>{{number_format($totVentas/$cfg->tasacambiaria,2, '.', ',')}} {{$cfg->simboloOM}}</b>
				  	@endif
				  </span>
				</div><!-- /.info-box-content -->
			</div>
