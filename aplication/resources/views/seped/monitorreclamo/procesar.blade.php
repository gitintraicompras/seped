<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="modal-procesar-{{$t->id}}">
{!! Form::open(array('action'=>array('AdmonitorreclamoController@procesar','method'=>'POST','autocomplete'=>'off'))) !!}
{{ Form::token() }}
