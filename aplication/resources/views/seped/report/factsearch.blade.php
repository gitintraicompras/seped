<!-- BUSCAR FACTURA -->
{!! Form::open(array('url'=>'/seped/report/facturas','method'=>'GET','autocomplete'=>'off','role'=>'search')) !!}
<div class="form-group">
	<div class="input-group" style="margin-left: 0px; width: 100px;">
		...
		<span class="input-group-addon" style="border:0px; "></span>
	   	<input style="width: 150px;" type="text" name="filtro" class="form-control" placeholder="Buscar" value="{{$filtro}}">
