		...
		<div class="col-md-4">
			...
			<div class="info-box info-box-20 bg-green"
				...
				<div class="info-box-content info-box-content-20">
				  ...
				  <span class="info-box-number"><?php echo e(number_format($totCxpBs,2, '.', ',')); ?> </span>
				  <div class="progress">
				    <div class="progress-bar" style="width: 20%"></div>
				  </div>
				  <span class="progress-description">
				  	<?php if($cfg->mostrarPrecioOM == 1): ?>
				  		<b><?php echo e(number_format($totCxpDs,2, '.', ',')); ?> <?php echo e($cfg->simboloOM); ?></b>
				  	<?php endif; ?>
				  </span>
				</div>
			</div>
		    ...
		    <div class="info-box info-box-30 bg-aqua"
			    ...
			    <div class="info-box-content info-box-content-30">
			      ...
			      <span class="info-box-number">
			      	<?php echo e(number_format($contProveedor,0, '.', ',')); ?>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\seped\aplication\resources\views/seped/indexAdmin.blade.php ENDPATH**/ ?>