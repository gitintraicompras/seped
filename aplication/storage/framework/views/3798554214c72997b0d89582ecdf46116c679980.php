			...
			<div class="modal-body" style="margin: 0px; padding: 0px;">
				...
				<div class="box box-primary" style="margin: 0px; padding: 0px;">
					<div class="box-header">
						<center><h3 class="box-title"><?php echo e($cfg->msgLitVip); ?>, DESCUENTO: <?php echo e(number_format($dcto, 2, '.', ',')); ?>%</h3></center>
						<center><h4 class="box-title"><?php echo e($cliente->nombre); ?></h4></center>
					</div>
					<center>
...
<?php /**PATH C:\xampp\htdocs\seped\aplication\resources\views/seped/catalogo/vip.blade.php ENDPATH**/ ?>