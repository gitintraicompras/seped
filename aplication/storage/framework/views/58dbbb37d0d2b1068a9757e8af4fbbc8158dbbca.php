...
<div id="page-wrapper">
	...
	<div class="row">
	    ...
	    <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
	        <?php echo $__env->make('seped.report.cxpsearch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
	    </div>
		...
		<div class="col-lg-3 col-md-3 col-sm-3 col-xs-12">
     		<div class="form-group">
  				<div class="input-group input-group-sm">
					<span class="input-group-addon" >Total(<?php echo e($cfg->simboloMoneda); ?>):</span>
                ...
                <table id="idtabla" class="table table-striped table-bordered table-condensed table-hover">
		            ...
		            <tr>
	                	...
	                	<td style="text-align: right;"><?php echo e(DiferenciaDias($t->fechai)); ?></td>
										<?php if( $cfg->mostrarPedidoOM > 0 ): ?>
	                		<td align='right' <?php if($t->saldoDs <0): ?> style="color: red;" <?php else: ?> style="color: blue;" <?php endif; ?>>
	                			<?php echo e(number_format($t->saldoDs, 2, '.', ',')); ?>
	                	...
	                	<td align='right' 
	                		<?php if($t->saldo <0): ?> style="color: red;" <?php else: ?> style="color: blue;" <?php endif; ?>>
	                		<?php echo e(number_format($t->saldo, 2, '.', ',')); ?>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\seped\aplication\resources\views/seped/report/cxps.blade.php ENDPATH**/ ?>