...
<div id="page-wrapper">
      ...
      <div class="col-lg-6 col-md-6 col-sm-6 col-xs-6">
        <?php echo $__env->make('seped.report.factsearch', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
      </div>
		            ...
		            <?php $__currentLoopData = $tabla; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $t): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
		                <tr>
		                	...
		                	<td>
								        ...
								        <!-- VER DETALLES -->
                        <a href="<?php echo e(URL::action('AdreportController@factura',$t->factnum)); ?>">
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\seped\aplication\resources\views/seped/report/facturas.blade.php ENDPATH**/ ?>