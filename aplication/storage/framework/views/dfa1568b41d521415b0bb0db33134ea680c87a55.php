	          	...
	          	<div <?php if($tab=="1"): ?> class="tab-pane active" <?php else: ?> class="tab-pane" <?php endif; ?> id="tab_1">
 			        <div class="btn-toolbar" role="toolbar" style="margin-bottom: 3px;">
			            <div class="btn-group" role="group" style="width: 100%;">
			                ...
			                &nbsp;&nbsp;
			                <?php echo $__env->make('seped.noticliente.confirmar', array('metodo'=>'leido','mensaje'=>'MARCAR TODAS LAS NOTIFICACIONES COMO LEIDAS'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
						    ...
						    &nbsp;&nbsp;
					        <?php echo $__env->make('seped.noticliente.confirmar', array('metodo'=>'borrar','mensaje'=>'BORRAR TODAS LAS NOTIFICACIONES'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
							...
							<div class="table-responsive">
								<table id="myTable1" class="table table-striped table-bordered table-condensed table-hover">
									...
									<tr>
										...
										<td>
											<a href="<?php echo e(URL::action('AdnotiClienteController@show',$t->item)); ?>">
									...
									<?php echo $__env->make('seped.noticliente.delete', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
		        ...
		        <div <?php if($tab=="2"): ?> class="tab-pane active" <?php else: ?> class="tab-pane" <?php endif; ?> id="tab_2">
		        	<div class="btn-toolbar" role="toolbar" style="margin-bottom: 3px;">
			            <div class="btn-group" role="group" style="width: 100%;">
			                ...
			                &nbsp;&nbsp;
							<a href="<?php echo e(url('/seped/noticliente/create')); ?>" title="Crear notificacioú nueva">
							    <i class="fa fa-file-o" style="margin-top: 15px;">
							    	Notificaciún nueva
								</i> 
							</a>
							&nbsp;&nbsp;
					        <?php echo $__env->make('seped.noticliente.confirmar', array('metodo'=>'borrar2','mensaje'=>'BORRAR TODAS LAS NOTIFICACIONES'), \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
							...
							<div class="table-responsive">
								<table id="myTable2" class="table table-striped table-bordered table-condensed table-hover">
									...
									<tr>
										<td><?php echo e($t->id); ?></td>
										<td>
											<a href="<?php echo e(URL::action('AdnotiClienteController@show2',$t->id)); ?>"><button style="height: 35px;" class="btn btn-default btn-pedido fa fa-file-o" title="Consultar notificaciún">
											</button>
											</a>

											<a href="" data-target="#modal-delete2-<?php echo e($t->id); ?>" data-toggle="modal">
												<button style="height: 35px;" class="btn btn-default btn-pedido fa fa-trash-o" data-toggle="tooltip" title="Eliminar notificaciún">
												</button>
											</a>
										</td>
									...
									<?php echo $__env->make('seped.noticliente.delete2', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
									<?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
								</table><br>
							</div>
						</div>
...
<?php echo $__env->make('layouts.menu', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\seped\aplication\resources\views/seped/noticliente/index.blade.php ENDPATH**/ ?>